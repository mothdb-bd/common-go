...
func NewSB2(className string) *StringBuilder {
	sb := &StringBuilder{
		sb: &strings.Builder{},
	}
...
func (b *StringBuilder) AddUInt8(key string, value uint8) *StringBuilder {
	b.AppendString(key).AppendString(":").AppendUInt8(value).AppendString(",")
	return b
}
...
func (b *StringBuilder) AppendUInt8(i uint8) *StringBuilder {
	b.sb.WriteString(strconv.FormatInt(int64(i), 10))
	return b
}
...
func (b *StringBuilder) AddUInt16(key string, value uint16) *StringBuilder {
	b.AppendString(key).AppendString(":").AppendUInt16(value).AppendString(",")
	return b
}
...
func (b *StringBuilder) AppendUInt16(i uint16) *StringBuilder {
	b.sb.WriteString(strconv.FormatInt(int64(i), 10))
	return b
}
...
func (b *StringBuilder) AddUInt32(key string, value uint32) *StringBuilder {
	b.AppendString(key).AppendString(":").AppendUInt32(value).AppendString(",")
	return b
}
